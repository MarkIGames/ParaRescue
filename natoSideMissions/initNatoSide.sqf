...
natosidemissionup = false;
publicVariable "natosidemissionup";
...
while {true} do
{
	...
	natosidemissionup = true;
	publicVariable "natosidemissionup";

	switch (mission) do
	{
		case 0: { execVM "natoSideMissions\Objectives\AUSMD_killOfficer.sqf"; };
		case 1: { execVM "natoSideMissions\Objectives\AUSMD_killAmmo.sqf"; };
		case 2: { execVM "natoSideMissions\Objectives\AUSMD_destoryVehicle.sqf"; };
	};
	
	waitUntil {!natosidemissionup};
	sleep 20;
};